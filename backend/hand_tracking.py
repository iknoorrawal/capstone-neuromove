...
# # #             print(f"Left Hand Coordinate: {left_hand_coord}")
# # #             print(f"Right Hand Coordinate: {right_hand_coord}")
# # #             recorded = True  # Set the flag to avoid re-recording

# # #         # Draw circles at recorded coordinates after countdown
# # #         if not countdown and recorded:
# # #             if left_hand_coord:
...
# #             if left_hand_coord:
# #                 cv2.circle(frame, left_hand_coord, 50, (0, 0, 255), -1)  # Red circle for left hand
# #                 # Display number1 inside the left hand circle
# #                 cv2.putText(frame, str(number1), (left_hand_coord[0] - 15, left_hand_coord[1] + 10),
# #                             cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 255), 2)

# #             if right_hand_coord:
# #                 cv2.circle(frame, right_hand_coord, 50, (255, 0, 0), -1)  # Blue circle for right hand
# #                 # Display number2 inside the right hand circle
...
# #         if left_hand_coord:
# #             cv2.circle(frame, (left_hand_coord[0]-100, left_hand_coord[1]), 50, (0, 0, 255), -1)  # Red circle for left hand
# #             cv2.putText(frame, str(number1), (left_hand_coord[0] - 15, left_hand_coord[1] + 10),
# #                         cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 255), 2)

# #         if right_hand_coord:
# #             cv2.circle(frame, (right_hand_coord[0]+100, right_hand_coord[1]), 50, (255, 0, 0), -1)  # Blue circle for right hand
# #             cv2.putText(frame, str(number2), (right_hand_coord[0] - 15, right_hand_coord[1] + 10),
# #                         cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 255), 2)
